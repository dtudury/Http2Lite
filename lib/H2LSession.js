const { Buffer } = require('buffer') // TODO: make little abstraction to use buffer or uint8array
...
class H2LSession extends Emitter {
  ...
  constructor (nextStreamId = 1) {
    ...
    this.frameBuffer = Buffer.alloc(0) // partial frame holder
   ...
   * @param {Buffer} frame - partial and/or multiple encoded http messages
   */
  writeFrame (frame) {
