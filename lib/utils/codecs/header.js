...
function decodeHeader (ui8a, byteOffset = 0) {
  ...
  if (firstByte & NEVER_INDEXED) {
    ...
    header = { kind: SIZE_UPDATE, maxSize: decodedMaxSize.value, byteOffset: decodedMaxSize.byteOffset }
    ...
    header = { kind: INDEXED, index: decodedIndex.value, byteOffset: decodedIndex.byteOffset }
  } else {
